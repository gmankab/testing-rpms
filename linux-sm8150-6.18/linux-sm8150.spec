...
License:         GPLv2
URL:             https://gitlab.postmarketos.org/soc/qualcomm-%{soc}/linux
Source0:         %{url}/-/archive/%{soc}/%{branch}/linux-%{soc}-%{branch}.tar.gz
Source1:         extra-%{soc}.config
Patch0:          slow-down-ufs.patch
...
%prep
%autosetup -n linux-%{soc}-%{branch} -p1
